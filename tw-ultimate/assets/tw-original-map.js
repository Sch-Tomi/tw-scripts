    ...
    ColorGroups = {
        ...
        , init: function (e) {
            this.color_picker.base_link = e, $(".colorgroup-own-activate").change(function () {
                ...
                UI.addConfirmBox("Biztosan tĂśrĂślni szeretnĂŠd ezeket a csoportokat?", a)
        ...
        , color_picker: {
            ...
            , openPopup: function (e, o) {
                var a = e.offset().left + 50
                    ...
                    , p = e.data("icon")
                    , c = e.data("t")
                    , s = this.base_link + "&r=" + t + "&g=" + i + "&b=" + n;
                c && (s += "&trans=" + c), this.r = t, this.g = i, this.b = n, this.group_id = l, this.group_type = o, this.icon = p, UI.AjaxPopup(null, "edit_color_popup", s, "SzĂ­nek szerkesztĂŠse", this.handleReload, {
                    dataType: "html"
                    , reload: !0
                }, !1, !1, a, r)
            }
            , handleReload: function (e, o) {
                ...
                })) : ($("#color_picker_submit").val("MentĂŠs"), $("#editcolorform").submit(function (e) {
        ...
        , Own: {
            ...
            , toggleCreation: function (e) {
                ...
                if (l = e.srcElement ? e.srcElement : e.target, $.cookie("popup_pos_own_villages")) {
                    var t = $.cookie("popup_pos_own_villages").split("x");
                    a = parseInt(t[0], 10), r = parseInt(t[1], 10)
            ...
            , changeColor: function (e, o, a, r, l, t) {
                TribalWars.post("map", {
                    ...
                    TWMap.legend.updateHighlight(TWMap.legend.CATEGORY_OWN, e, i.group_name, t ? null : {
                        r: o
                        , g: a
                        , b: r
                    }, l);
                    var n = t ? "none" : "rgb(" + o + "," + a + "," + r + ")"
                        , p = l ? '<img style="height:12px;width:12px;" src="' + escapeHtml(l, !0) + '">' : ""
                        , c = $('.colorgroup-own-entry[data-id="' + e + '"]');
                    c.find(".marker").css("background-color", n).html(p), c.find(".color_picker_launcher").data("r", o).data("g", a).data("b", r).data("icon", l).data("t", t), ColorGroups.Own.groups[e].marker.c = n, ColorGroups.Own.groups[e].marker.img = l;
                    for (var s = ColorGroups.Own.groups[e].villages, u = 0; u < s.length; u++) TWMap.villageIcons[s[u]]["group_" + e] = ColorGroups.Own.groups[e].marker;
                    TWMap.map.reload(!0)
                })
            }
        }
        , Other: {
            ...
            , changeColor: function (e, o, a, r) {
                TribalWars.post("map", {
                    ...
                    var t = $('.colorgroup-other-entry[data-id="' + e + '"]');
                    t.find(".marker").css("background-color", "rgb(" + o + "," + a + "," + r + ")"), t.find(".color_picker_launcher").data("r", o).data("g", a).data("b", r)
                })
            }
            ...
            , editor: {
                    ...
                    e === o.ENTITY_TRIBE && (a = "colorgroup_get_tribes", r = $("#tribes > tbody")), e === o.ENTITY_PLAYER && (a = "colorgroup_get_players", r = $("#players > tbody")), e === o.ENTITY_VILLAGE && (a = "colorgroup_get_villages", r = $("#villages > tbody")), TribalWars.post("map", {
                        ...
                        r.empty(), $(a).each(function (a, l) {
                            var t = $("<tr>")
                                , i = ""
                                , n = escapeHtml(l.name);
                            e === o.ENTITY_TRIBE && (i = '<img src="' + l.ally_image + '" class="userimage-tiny"> ', n += " [" + escapeHtml(l.tag) + "]"), e === o.ENTITY_PLAYER && (i = '<img src="' + l.player_image + '" class="userimage-tiny"> ');
                            var p = $("<td>").html(i + n)
                                , c = $("<a>").attr("href", "#").html("tĂśrlĂŠs").click(function () {
                                    return o.removeMember(e, l.id), !1
                                })
                                , s = $("<td>").append(c);
                            t.append(p), t.append(s), r.append(t)
                ...
                , renameGroup: function (e) {
                    ...
                    o.ajax_request("rename", {
                        ...
                        $("#groupname_" + o.group_id).html(escapeHtml(e)), TWMap.legend.updateHighlight(TWMap.legend.CATEGORY_OTHER, o.group_id, e, a.color), UI.SuccessMessage("A csoport ĂĄtnevezĂŠse megtĂśrtĂŠnt")
                    })
                }
                , addTribe: function (e) {
                    this.ajax_request("add_tribe", {
                        ...
                        $("#new_tribe").val("").focus(), MapHighlighter.alterAlly(e.ally_id, e.color), MapHighlighter.colorAlly(e.ally_id), TWMap.minimap_cache_stamp++, TWMap.minimap.reload(!0), UI.SuccessMessage("Ăj klĂĄn kerĂźlt a csoporthoz hozzĂĄadĂĄsra")
                    })
                }
                , removeTribe: function (e) {
                    this.ajax_request("del_tribe", {
                        ...
                        MapHighlighter.alterAlly(e, o.color), MapHighlighter.colorAlly(e), TWMap.minimap_cache_stamp++, TWMap.minimap.reload(!0), UI.SuccessMessage("A klĂĄn eltĂĄvolĂ­tĂĄsra kerĂźlt a csoportbĂłl")
                    })
                }
                , addPlayer: function (e) {
                    this.ajax_request("add_player", {
                        ...
                        $("#new_player").val("").focus(), MapHighlighter.alterPlayer(e.player_id, e.color), MapHighlighter.colorPlayer(e.player_id), TWMap.minimap_cache_stamp++, TWMap.minimap.reload(!0), UI.SuccessMessage("Ăj jĂĄtĂŠkos kerĂźlt hozzĂĄadĂĄsra a csoporthoz")
                    })
                }
                , removePlayer: function (e) {
                    this.ajax_request("del_player", {
                        ...
                        MapHighlighter.alterPlayer(e, o.color), MapHighlighter.colorPlayer(e), TWMap.minimap_cache_stamp++, TWMap.minimap.reload(!0), UI.SuccessMessage("A jĂĄtĂŠkos eltĂĄvolĂ­tĂĄsra kerĂźlt a csoportbĂłl")
                    })
                }
                , addVillage: function (e, o) {
                    this.ajax_request("add_village", {
                        ...
                        $("#add_vilage_x").focus(), MapHighlighter.alterVillage(e.village_id, e.color), "undefined" != typeof TWMap.villageKey[e.village_id] && MapHighlighter.colorVillage(TWMap.villages[TWMap.villageKey[e.village_id]]), TWMap.minimap_cache_stamp++, TWMap.minimap.reload(!0), UI.SuccessMessage("HozzĂĄadtad a falut a csoporthoz")
                    })
                }
                , removeVillage: function (e) {
                    this.ajax_request("del_village", {
                        ...
                        MapHighlighter.alterVillage(e, o.color), "undefined" != typeof TWMap.villageKey[e] && MapHighlighter.colorVillage(TWMap.villages[TWMap.villageKey[e]]), TWMap.minimap_cache_stamp++, TWMap.minimap.reload(!0), UI.SuccessMessage("EltĂĄvolĂ­tottad a falut a csoportbĂłl")
                    })
                }
...
function FreeMap(e, t, i, s, o) {
    ...
    return this._lastTopLeftSector = [0, 0], this._lastBottomRightSector = [0, 0], this._visibleSectors = {}, this._loadedSectors = {}, this.viewport = [0, 0, 0, 0], this.bias = o, this._handleClick = function (e) {
        ...
        return this.handler.onClick(t[0], t[1], e)
        ...
        return i === !0 && (s -= s % this.scale[0], o -= o % this.scale[1]), this.setPosPixel(s, o)
        ...
        if (!compareCoord(this._lastTopLeftSector, l) || !compareCoord(this._lastBottomRightSector, d)) {
            ...
            if (c.length) {
                this.handler.preLoad && this.handler.preLoad(c.length);
...
function FreeMapMover(e) {
    this.moveDirty = !1, this.allowDrag = !0, this.dragHandler = null, this.dragBeginHandler = null, this.dragEndHandler = null, this.dragBeginPosition = [], this.fixTouchEvent = function (e) {
        ...
        if (this.touchIdentifier = null, this.crappy_browser ? (this._el.releaseCapture(), this._el.detachEvent("onmousemove", this._eventHandleMouseMove), this._el.detachEvent("onmouseup", this._eventHandleMouseUp), this._el.detachEvent("onlosecapture", this._eventHandleMouseUp)) : (window.removeEventListener("touchmove", this._eventHandleMouseMove, !0), window.removeEventListener("mousemove", this._eventHandleMouseMove, !0), window.removeEventListener("touchend", this._eventHandleMouseMove, !0), window.removeEventListener("mouseup", this._eventHandleMouseUp, !0)), this.useDragTimer !== !1 && (clearInterval(this.dragTimer), this.dragTimer = void 0), this.moveDirty && (this.allowDrag && this._map.handler.hasOwnProperty("onDragEnd") ? this._map.handler.onDragEnd() : this.dragEndHandler && this.dragEndHandler()), !this.moveDirty && e.changedTouches && this._map.handler.onClick) {
            ...
            e.stopPropagation(), this._map.handler.onClick(i[0], i[1])
        }
        ...
        , onMovePixel: function (e, a) {
            if (!TWMap.busy) {
                if (TWMap.busy = !0, TWMap.map) {
                    ...
                    TWMap.map.setPos(t, i), TWMap.home.updateDisplay()
                }
    ...
    , popup: {
        ...
        , displayForVillage: function (e, a, t) {
            if (this._currentVillage == e.id) {
                ...
                if (e.hasOwnProperty("special") && (n.special = e.special), e.bonus && (n.bonus = {
                    ...
                    n.owner = i, i.newbie && e.owner != game_data.player.id && (n.owner.newbie_time = i.newbie), i.image_id && i.image_id > 0 && (n.owner_image = Format.userImageThumbURL(i.image_id));
                    var o = TWMap.allies[i.ally];
                    o && (n.ally = o, o.image_id && o.image_id > 0 && (n.ally_image = Format.userImageThumbURL(o.image_id)))
                }
        ...
        , calcPos: function () {
            var e = [this.el.width(), this.el.height()]
                , a = 3
                , t = [$(window).scrollLeft() + a, $(window).scrollTop() + a, $(window).scrollLeft() + $(window).width() - a, $(window).scrollTop() + $(window).height() - a];
            t[1] += $("#topContainer").height(), t[3] -= $("#footer").height(), this._py + 15 + e[1] < t[3] ? y = this._py + 15 : this._py - 15 - t[1] >= e[1] ? y = this._py - e[1] - 15 : y = this._py + 15, x = this._px + 15, x -= Math.max(0, x + e[0] - t[2]), x = Math.max(x, $(window).scrollLeft()), this.el.css("left", x + "px"), this.el.css("top", y + "px")
        }
        , initTimers: function () {
            var e = this;
...
var TroopTemplates = {
    ...
    , validate: function () {
        return $("#template_name").val().length < 1 ? (UI.ErrorMessage("A sablonnak ĂŠrvĂŠnyes nevet kell megadnod."), !1) : $("#template_name").val().length > 50 ? (UI.ErrorMessage("A sablon neve tĂşl hosszĂş (max.: 50 karakter)"), !1) : "" != $("#template_name").val().trim() || (UI.ErrorMessage("A sablonnak legalĂĄbb 1 lĂĄthatĂł karaktert kell tartalmaznia."), !1)
    }
    ...
    , selectCreate: function (e) {
        if ("undefined" != typeof e && e.preventDefault(), TroopTemplates.currentTemplates >= TroopTemplates.maxTemplates) return UI.ErrorMessage("ElĂŠrted a sablonok maximĂĄlis szĂĄmĂĄt."), !1;
        var t = mobile ? "number" : "text";
        $("#troop_template_units").find("input[type=" + t + "]").val(""), $("#template_id").val(0), $("#template_name").val(""), $("#template_button").val("Sablon lĂŠtrehozĂĄsa"), TroopTemplates.setSelected(0)
    }
    , selectTemplate: function () {
        ...
        TroopTemplates.setSelected(a), $("#template_id").val(l.id), $("#template_name").val(l.name), $("#template_button").val("Sablon mĂłdosĂ­tĂĄsa"), $.each(l, function (e, t) {
            var a = $("#unit_input_" + e);
            a.length && a.val(t)
        })
    }
...
! function () {
    "use strict";
    TargetSelection = function (t) {
        var e = this;
        this.$container = null, this.on_confirm_village = function (t) {}, this.request_id = 0, this.selected_index = null, this.num_villages = 0, this.page_limit = null, this.last_attacked = null, this.autocomplete_visible = !1, this.ie_compatibility_mode = !0, this.confirmed_village_data = !1, this.read_only = !1, this.clicked_button = "attack", this.autocomplete_wrapper = null, this.input_text_field = null, this.script_watcher = null, this.script_old_x = "", this.script_old_y = "", this.construct = function (t) {
            var i = $(t);
            this.$container = i, this.input_text_field = i.find("input[type=text]"), this.initAutoComplete(), this.changeSearchType.call(i.find("input[type=radio]:checked"), !1), this.page_limit = Math.min(Math.max(Math.round(($(window).height() - this.input_text_field.offset().top) / 50), 5), 10), this.setAutoCompleteWrapperPosition(), this.input_text_field.on("input", function () {
                e.ie_compatibility_mode = !1, e.fetchVillages()
            }).on("keyup", e.textFieldKeyUp).on("keydown", e.textFieldKeyDown).on("remove", e.destroy), i.find("input[type=radio]").on("change", this.changeSearchType), this.input_text_field.parents("form").on("submit", this.beforeSubmit), $(window).on("click", this.onWindowClick), i.find(".btn").on("click", function () {
                e.clicked_button = $(this).attr("name")
            });
            var l = i.data("on-choice");
            l && this.setConfirmHook(l)
        }, this.destroy = function () {
            clearInterval(e.script_watcher), $(window).off("click", e.onWindowClick), this.input_text_field = null
        }, this.onWindowClick = function () {
            e.autocomplete_visible && e.hideAutoCompleteWrapper()
        }, this.initAutoComplete = function () {
            this.$container.find(".target-input-autocomplete").autocomplete({
                minLength: 2
                , source: UI.AutoComplete.source
            }), this.input_text_field.on("autocompleteselect", function (t, i) {
                e.fetchVillages({
                    input: i.item.value
                })
            })
            ...
            var t = $("#inputx").val()
                , i = $("#inputy").val()
                , l = e.confirmed_village_data ? e.confirmed_village_data.x : ""
                , a = e.confirmed_village_data ? e.confirmed_village_data.y : "";
            t && i && (t !== l || i !== a) && (clearInterval(e.script_watcher), e.setVillageByCoordinates(t, i, function () {
                $("#inputx").val(""), $("#inputy").val(""), e.initScriptCompatibility()
            }))
        }, this.setReadOnly = function () {
            this.read_only = !0
        }, this.setLastAttacked = function (t) {
            this.last_attacked = t, this.$container.find(".target-last-attacked").show().on("click", function (t) {
                t.preventDefault(), e.confirmVillage(e.getVillageDiv(e.last_attacked))
            })
        }, this.enableQuickButton = function (t, e) {
            $(".target-" + t).show().on("click", function (t) {
                TargetSelection.loadTargetsPopup(t, e)
            })
        }, this.setVillageByCoordinates = function (t, i, l) {
            this.fetchVillages({
                type: "coord"
                , input: t + "|" + i
            }, function (t) {
                t.villages.length && e.confirmVillage(e.getVillageDiv(t.villages[0])), "function" == typeof l && l()
            })
        }, this.setVillageByData = function (t) {
            this.confirmVillage(e.getVillageDiv(t))
        }, this.beforeSubmit = function () {
            var t = $("#inputx")
                , i = $("#inputy")
                , l = e.$container.find(".target-input .village-item");
            if (l.length) {
                var a = l.data("village_data");
                t.val(a.x), i.val(a.y)
            }
            var n, o = e.$container.find("input[type=text]").val();
            return (n = o.match(/^([0-9]{1,3})\|([0-9]{1,3})$/)) && (t.val(n[1]), i.val(n[2])), !0
        }, this.changeSearchType = function (t) {
            var i, l = $(this)
            ...
            a.attr("placeholder", i).data("search-type", l.val()), e.clearVillages(), "player_name" === l.val() ? (a.autocomplete("enable"), a.autocomplete("search")) : a.autocomplete("disable"), t !== !1 && a.focus()
        }, this.clearVillages = function () {
            this.hideAutoCompleteWrapper(), this.removeConfirmedVillage()
        }, this.fetchVillages = function (t, i) {
            var l = {
            ...
            l = $.extend(l, t), 0 !== l.input.length && ("undefined" == typeof i && (i = function (t) {
                e.handleVillagesData(t)
            }), TribalWars.get("api", l, i))
        }, this.handleVillagesData = function (t) {
            if (t.request_id === this.request_id) {
                var i = this.getAutoCompleteWrapper();
                if (this.hideAutoCompleteWrapper(), this.num_villages = t.villages.length + t.offset, 0 === t.offset ? (this.selected_index = null, i.empty()) : i.find(".village-more").remove(), 0 !== t.villages.length) {
                    if (this.showAutoCompleteWrapper(), $.each(t.villages, function (t, l) {
                            i.append(e.getVillageDiv(l))
                        }), t.more) {
                        var l = $('<div class="village-item village-more">Mutass tĂśbbet</div>').on("click", function (t) {
                            t.stopPropagation(), e.loadMoreVillages()
                        });
                        i.append(l)
                    }
            ...
            var t = this.getAutoCompleteWrapper()
                , e = this.$container.find(".target-input")
                , i = e.offset()
                , l = e.height();
            t.css("width", e.width() + 2 + "px"), t.css("max-height", 50 * this.page_limit + "px"), t.css("left", i.left);
            var a = t.height()
                , n = $(document).height() - i.top - l - $("#footer").height();
            a > n ? (t.css("top", i.top - a - 2 + "px"), t.css({
                "border-top-width": "1px"
                , "border-bottom-width": "0px"
            })) : (t.css("top", i.top + l + 2 + "px"), t.css({
                "border-top-width": "0px"
                , "border-bottom-width": "1px"
            }))
        }, this.setConfirmHook = function (t) {
            for (var e = t.split("."), i = e.pop(), l = window, a = 0; a < e.length; a++) l = l[e[a]];
            var n = l[i];
            if ("function" != typeof n) throw "non-existent function specified for TargetSelection on-choice";
            this.on_confirm_village = n
        }, this.confirmVillage = function (t) {
            this.removeConfirmedVillage(), this.getAutoCompleteWrapper().hide();
            var e = this.$container.find(".target-input");
            e.find("input").hide(), e.append(t), t.removeClass("village-selected"), this.confirmed_village_data = t.data("village_data"), this.updateURLForConfirmedVillage(), this.on_confirm_village(this.confirmed_village_data)
        }, this.removeConfirmedVillage = function () {
            var t = this.$container.find(".target-input");
            t.find(".village-item").length && (t.find("input").show().val("").focus(), t.find(".village-item").remove(), this.confirmed_village_data = !1, $("input[name=x], input[name=y]").val(""), this.updateURLForConfirmedVillage())
        }, this.getVillageDiv = function (t) {
            var i = $('<div class="village-item"><img class="village-delete" alt="" /><img class="village-picture" alt="" /><span class="village-name"></span><span class="village-info"></span><span class="village-distance"></span></div>').data("village_data", t);
            this.read_only || i.on("click", function (t) {
                t.stopPropagation(), $(this).parent().hasClass("target-select-autocomplete") ? e.confirmVillage(i) : e.removeConfirmedVillage()
            });
            var l = t.name;
            l.length > 18 && (l = l.substr(0, 18) + "&hellip;");
            var a = s("%1 (%2|%3)", l, t.x, t.y)
                , n = t.player_name ? t.player_name : "BarbĂĄr"
                , o = "<strong>Tulajdonos:</strong> " + n + " <strong>Pontok:</strong> " + t.points
                , r = Math.round(Math.sqrt(t.distance))
                , c = 1 === r ? s("%1 mezĹ", r) : s("%1 mezĹ", r)
                , h = "<strong>TĂĄvolsĂĄg:</strong> " + c;
            return i.find(".village-picture").attr("src", t.image), i.find(".village-delete").attr("src", image_base + "/delete.png"), i.find(".village-name").html(a), i.find(".village-info").html(o), i.find(".village-distance").html(h), this.read_only && i.addClass("read-only"), i
        }, this.textFieldKeyUp = function (t) {
            e.ie_compatibility_mode && 38 !== t.keyCode && 40 !== t.keyCode && e.fetchVillages();
            var i = $(this)
                , l = i.val();
            return "coord" === i.data("search-type") && (l = l.replace(/[,\.]/, "|"), l = l.replace(/[^[0-9\|]+/, ""), 3 === l.length && 8 !== t.keyCode && 46 !== t.keyCode && (l += "|"), l.indexOf("||") !== -1 && (l = l.replace(/(\|{2,})/, "|")), l.length > 7 && (l = l.substr(0, 7)), i.val(l)), !0
        }, this.textFieldKeyDown = function (t) {
            return 38 === t.keyCode ? (e.selectPrevVillage(), !1) : 40 === t.keyCode ? (e.selectNextVillage(), !1) : 13 !== t.keyCode || (e.confirmVillageAtIndex(e.selected_index), !1)
        ...
        }, this.selectVillageAtIndex = function (t) {
            this.unselectSelectedVillage();
            var e = this.getAutoCompleteWrapper().find("div").eq(t);
            e.addClass("village-selected"), this.selected_index = t;
            var i = 41 * t
                , l = e.position().top
                , a = parseInt(e.parent().css("max-height"));
            l < 10 ? e.parent().scrollTop(i) : l > a - 40 && e.parent().scrollTop(i)
        }, this.unselectSelectedVillage = function () {
            this.getAutoCompleteWrapper().find("div.village-selected").removeClass("village-selected")
        }, this.confirmVillageAtIndex = function (t) {
            var e = this.getAutoCompleteWrapper().find("div").eq(t);
            e.length && (e.hasClass("village-more") ? (this.loadMoreVillages(), this.selectVillageAtIndex(t - 1)) : this.confirmVillage(e))
        }, this.updateURLForConfirmedVillage = function () {
            var t = this.confirmed_village_data ? this.confirmed_village_data : {
                    id: 0
                }
                , e = document.location.href;
            "#" === e.substr(-1) && (e = e.substr(0, e.length - 1));
            var i = /target=([0-9]+)/;
            e.match(i) ? e = e.replace(i, "target=" + t.id) : e += "&target=" + t.id, Modernizr.history && history.replaceState({}, "", e)
        }, this.loadMoreVillages = function () {
            this.fetchVillages({
                offset: this.num_villages
            })
        }, this.construct(t)
    }, TargetSelection.loadTargetsPopup = function (t, e) {
        UI.AjaxPopup(t, "village_targets", e, "CĂŠlpontok", null, {
            reload: !0
        }, null, 400)
    }
}();
...
var Warplanner = {
    ...
    , init: function () {
        this.el.root = $("#warplanner"), this.el.list = $("#warplanner_players"), this.el.search = $("#warplanner_search"), this.el.map_mover = $("#map_mover"), this.el.select = this._createSelectionDiv(), this.el.bb = $("#warplanner_bb"), this.el.bb_popup = $("#warplanner_bb_popup"), this.el.bb_popup.draggable({
            ...
            for (var t, a = e.target, r = 0; a && r < 5 && !(t = jQuery.data(a, "pid")); r++) a = $(a).parent(), a = a[0];
            return !t || (setTimeout(jQuery.proxy(function () {
                this.el.list.find("td").removeClass("selected"), a = $(a), a.find("input[type=radio]").attr("checked", "checked"), a.find("td").addClass("selected"), this.selectPlayer(t)
            }, this), 0), e.target.className.match(/wp_col/) ? this.onClickColorDiv(e, t) : e.target.className.match(/wp_del/) ? this.clearAllForPlayer(t) : e.target.className.match(/wp_bb/) && this.createBB(t), !0)
        }, this));
        ...
        this.el.search.change(e).keyup(e).keypress(jQuery.proxy(function (e) {
            ...
            if (Warplanner.locked === !0) return "A tĂĄmadĂĄstervezĹben vĂŠgrehajtott vĂĄltoztatĂĄsok mentĂŠse mĂŠg nem tĂśrtĂŠnt meg."
    ...
    , show: function () {
        this.reload(function () {
            this.initPos || (this.initPos = !0, this.el.root.css("left", "5px").css("top", (window.pageYOffset || window.scrollY) + 60 + "px")), this.el.root.show(), this.el.search.focus(), this.visible = !0, this.admin && TWMap.map.mover.preventDrag(jQuery.proxy(function (e, t) {
                var a = [t[0] - e[0], t[1] - e[1]]
                    , r = this.el.map_mover.offset();
                r.left -= $(window).scrollLeft(), r.top -= $(window).scrollTop(), e = [e[0] - r.left, e[1] - r.top], a[0] < 0 && (e[0] += a[0], a[0] = -a[0]), a[1] < 0 && (e[1] += a[1], a[1] = -a[1]), this.selectArea = [e[0], e[1], e[0] + a[0], e[1] + a[1]], this.el.select.height(a[1]).width(a[0]).css({
                    top: e[1] + "px"
                    , left: e[0] + "px"
                })
                ...
                this.el.select.hide();
                var e, t;
                e = (this.selectArea[0] + TWMap.map.pos[0]) / TWMap.map.scale[0], t = (this.selectArea[1] + TWMap.map.pos[1]) / TWMap.map.scale[1];
                var a = [~~e, ~~t];
                e = (this.selectArea[2] + TWMap.map.pos[0]) / TWMap.map.scale[0], t = (this.selectArea[3] + TWMap.map.pos[1]) / TWMap.map.scale[1];
                var r = [~~e, ~~t];
                for (e = a[0]; e <= r[0]; e++)
                    for (t = a[1]; t <= r[1]; t++) {
                        var i = 1e3 * e + t
                            , s = TWMap.villages[i];
                        s && "ghost" != s.special && (this.data[s.id] && this.data[s.id].player_id === this.curPlayer && this.data[s.id].type === this.attackType ? this.data[s.id].type = "D" : (this.lock(!0), this.data[s.id] = {
    ...
    , hide: function () {
        ...
        var t = "A nem mentett informĂĄciĂłk elvesznek. Folytatod?"
            , a = [{
                text: "JĂłvĂĄhagy"
                , callback: e
                , confirm: !0
            }];
        UI.ConfirmationBox(t, a)
    }
    , reload: function (e) {
        this.players = {}, $.ajax({
            url: this.urls.read
            , dataType: "json"
            , success: jQuery.proxy(function (t) {
                if (t.code !== !0) return void UI.ErrorMessage("Hiba tĂśrtĂŠnt a tĂĄmadĂĄstervezĹ betĂśltĂŠse kĂśzben.");
                for (var a in t.members)
                    if (t.members.hasOwnProperty(a)) {
                        var r = t.members[a];
                        this.addPlayer(r.name, a, r.color)
                    }
                for (var i in t.villages)
                    if (t.villages.hasOwnProperty(i)) {
                        var s = t.villages[i];
                        this.data[s.village_id] = {
    ...
    , createPlayerListLinks: function () {
        ...
        if (this.admin) var t = $("<img/>").attr("src", TWMap.image_base + "/delete_small.png").addClass("wp_del");
        var a = $("<img/>").css("padding-left", "3px").attr("src", TWMap.image_base + "/forwarded.png").addClass("wp_bb");
    ...
    , _fillPlayerList: function () {
        ...
        for (a in this.players)
            if (this.players.hasOwnProperty(a)) {
                var s = this.players[a];
                if ("" === t || s.name.toLowerCase().indexOf(t) !== -1) {
                    var l = document.createElement("tr")
                        , o = $(l);
                    o.html(this.playerTpl), o.find(".wp_name").text(s.name).append(i.clone()), o.find(".wp_col").css("background-color", "rgb(" + s.color[0] + "," + s.color[1] + "," + s.color[2] + ")"), this.curPlayer === s.id && (o.find("td").addClass("selected"), o.find("input[type=radio]").attr("checked", "checked")), jQuery.data(l, "pid", s.id), this.curFilter.push(s.id), r.appendChild(l)
                }
            }
        e.append(r)
    }
    , addPlayer: function (e, t, a) {
        t = ~~t, this.players[t] = {
            id: t
            , name: e
            , color: a
    ...
    , selectPlayer: function (e) {
        ...
        return !!t && void(this.curPlayer = e)
    }
    , getColorByPlayerId: function (e) {
        return this.players[e].color
    }
    , onClickColorDiv: function (e, t) {
        var a = e.pageX
            , r = e.pageY
            , i = this.players[t];
        this.colorEditPlayer = t;
        var s = this.urls.colorPopup + "&r=" + i.color[0] + "&g=" + i.color[1] + "&b=" + i.color[2];
        UI.AjaxPopup(null, "warplanner_color_popup", s, "SzĂ­n kivĂĄlasztĂĄsa", jQuery.proxy(this.onColorLoaded, this), {
            dataType: "html"
            , reload: !0
        }, 280, 200, a, r)
    }
    , onColorLoaded: function (e) {
        ...
        var t = this.players[this.colorEditPlayer].color;
        $("#color").css("background-color", "rgb(" + t[0] + "," + t[1] + "," + t[2] + ")"), $("#color_picker_r").val(t[0]), $("#color_picker_g").val(t[1]), $("#color_picker_b").val(t[2]), $("#icon_picker").hide(), $("#color_picker").show(), $("#warplanner_color_popup_content").find("form").submit(jQuery.proxy(this.onColorSubmit, this))
    }
    , onColorSubmit: function () {
        var e = $("#color_picker_r").val()
            , t = $("#color_picker_g").val()
            , a = $("#color_picker_b").val();
        return this.players[this.colorEditPlayer].color = [e, t, a], this.lock(!0), this._fillPlayerList(), TWMap.reload(!1), $("#warplanner_color_popup").toggle(), !1
    }
    , createBB: function (e) {
        var t = {};
        for (var a in this.data)
            if (this.data.hasOwnProperty(a)) {
                var r = this.data[a].player_id
                    , i = this.data[a].type;
                0 != e && r != e || "D" !== i && (t.hasOwnProperty(r) || (t[r] = {
                    name: this.players[r].name
                    , village_ids: []
                    , types: []
                }), t[r].village_ids.push(a), t[r].types.push(i))
            }
        $.post(Warplanner.urls.genbb, {
            ...
            if (e.code === !0) {
                var t = e.bb;
                $.browser.msie && (t = t.replace(/\n/g, "<br/>")), this.el.bb_popup.show(), this.el.bb.html(t).focus()[0].select()
            } else UI.ErrorMessage(e.msg)
        }, this), "json")
    }
    , onVillageClicked: function (e, t, a) {
        var r = 1e3 * t + a
            , i = TWMap.villages[r];
        if ("ghost" == i.special) return !1;
        if (this.data[e] && "D" !== this.data[e].type && this.data[e].player_id === this.curPlayer) {
            var s = this.attackType;
            this.data[e].type === s ? this.data[e].type = "A" === s ? "F" : "A" : this.data[e].type = "D"
        } else this.data[e] = {
            player_id: this.curPlayer
            , type: this.attackType
        };
    ...
    , clearAllForPlayer: function (e) {
        var t = !1;
        for (var a in this.data) this.data.hasOwnProperty(a) && "D" !== this.data[a].type && this.data[a].player_id === e && (t = !0, this.data[a].type = "D");
        t && (this.lock(!0), TWMap.reload(!1))
    }
    , lock: function (e, t) {
        "pending" === this.locked || !t && this.locked === e || (this.locked = "pending", $.post(this.urls.lock, {
            lock: !0
        }, jQuery.proxy(function (t) {
            t.code === !0 ? this.setLocked(e) : (alert(t.msg), this.setLocked(!1))
        }, this), "json"))
    }
    ...
    , save: function () {
        if (this.locked !== !0) return void UI.ErrorMessage("Jelenleg nem lehet elmenteni a vĂĄltoztatĂĄsaidat.");
        var e = {};
        for (var t in this.data) this.data.hasOwnProperty(t) && (e[t] = {
            p: this.data[t].player_id
            , t: this.data[t].type
        });
        var a = {};
        for (var t in this.players) this.players.hasOwnProperty(t) && (a[t] = {
            c: this.players[t].color.join(",")
        });
        $.post(this.urls.save, {
            villages: e
            , players: a
    ...
    , Modes: {
        ...
        , all_own_offer: {
            ...
            , acceptOffer: function (e, t) {
                TribalWars.post("market", {
                    ...
                    t.hasOwnProperty("expired") ? (UI.ErrorMessage(t.expired), a.removeOfferDisplay()) : (UI.SuccessMessage("Elfogadtad az ajĂĄnlatot."), 0 === t.offers_remaining ? a.removeOfferDisplay(e) : a.updateOffer(e, t.offers_remaining), a.updateMerchants(t.merchants_available, t.merchants_total, t.merchant_carry))
                })
            }
            ...
            , updateMerchants: function (e, t, a) {
                ...
                $(".offer_container").each(function () {
                    ...
                    ["wood", "stone", "iron"].forEach(function (e) {
                        n += a[e], a[e] > 0 && (s = Math.floor(o[e] / a[e]))
                    });
                    var l = n > 0 ? Math.floor(r / n) : 0
                        , f = Math.min(s, l, i);
                    $fillmax = $("#fillmax_" + t), $fillmax.html(f).data("max", f)
                })
            }
            , fillMax: function (e) {
        ...
        , other_offer: {
            ...
            , acceptOffer: function (e, t) {
                TribalWars.post("market", {
                    ...
                    e.hasOwnProperty("expired") ? UI.ErrorMessage(e.expired) : UI.SuccessMessage("Elfogadtad az ajĂĄnlatot."), partialReload()
                })
            }
            , submitOfferAcceptForm: function (e) {
        ...
        , mass_create_offers: {
            ...
            , displayCreationErrors: function (e) {
                var t = '<div class="error_box">NĂŠhĂĄny ajĂĄnlat nem hozhatĂł lĂŠtre:<ul>';
                $.each(e, function (e, a) {
            ...
            , saveTemplate: function (e) {
                ...
                TribalWars.post("market", {
                    ...
                    UI.SuccessMessage("Az ajĂĄnlati sablon ĂŠs a tartalĂŠk ehhez a csoporthoz kerĂźlt mentĂŠsre.")
                })
            }
            , fillFromTemplate: function (e) {
                if (!this.lock_fill) {
                    ...
                    if (e.sell_type === e.buy_type) return UI.ErrorMessage("EltĂŠrĹ nyersanyagot kell vĂĄlassz a kereskedelemhez."), void a();
                    if (e.max_time < 1 || e.max_time > 96) return UI.ErrorMessage("A maximĂĄlis ĂştidĹ 1 ĂŠs 96 Ăłra kĂśzĂśtt kell legyen."), void a();
                    var r = function () {
                        $.each(t.villages, function (a, r) {
                            ...
                            var l = r[o]
                                , f = e["buffer_" + o]
                                , c = Math.max(0, l - f)
                                , _ = Math.floor(c / e.sell_value)
                                , u = Math.max(0, r.trader_free - e.buffer_trader)
                                , d = Math.ceil(e.sell_value / r.trader_carry)
                                , m = Math.floor(u / d)
                                , p = Math.min(e.count, _, m);
            ...
            , createOffers: function () {
                if (!this.lock_create) {
                    ...
                    if ($.each(this.villages, function (t, a) {
                        ...
                        }), 0 === e) return this.unlockCreate(), void UI.ErrorMessage("AjĂĄnlat nem kerĂźlt megnevezĂŠsre");
                    var t = this
                    ...
                    TribalWars.post("market", {
                        ...
                        var a = function () {
                                e.success_message ? UI.SuccessMessage(e.success_message) : $.isEmptyObject(e.village_errors) && UI.ErrorMessage("Nincs ajĂĄnlat megadva .")
                            }
                            ...
                            , s = function () {
                                for (; n < r.length;) {
                                    var l = r[n];
                                    if (t.updateVillageInfo(e.villages[l]), "undefined" != typeof e.successful_offers[l] && t.resetVillageOffer(l), n++, n % o === 0) break
                                }
            ...
            , initVillageForm: function () {
                ...
                var i = Object.keys(e.villages)
                    ...
                    , l = function () {
                        for (; s < i.length;) {
                            var f = i[s];
                            if (o.append(e.genVillageRow(e.villages[f])), s++, a.width(s / i.length * 100 + "%"), s % n === 0) break
                        }
                        s === i.length ? (e.unlockFill(), e.unlockCreate(), t.hide(), r.find(".blocker").hide(), r.css("opacity", 1)) : setTimeout(function () {
                            l()
                        }, 1)
                    };
                l()
