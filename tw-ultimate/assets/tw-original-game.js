...
function selectTarget(e, t, n) {
    n = n || "";
    var o = $('form[name="units"], form[name="market"], form[name="secret"]')[0];
...
var mx = 0
    ...
    , villageDock = {
        ...
        , open: function (e) {
            return 0 == villageDock.docked && villageDock.saveDockMode(1), UI.AjaxPopup(e, "group_popup", villageDock.loadLink, "Falu csoportok", villageDock.callback, null, 320, 380, null, null, ["#open_groups", "#close_groups"]), $("#close_groups, #open_groups").toggle(), !1
        }
        , close: function (e) {
...
Array.prototype.fill || Object.defineProperty(Array.prototype, "fill", {
    value: function (e) {
        ...
        for (var t = Object(this), n = t.length >>> 0, o = arguments[1], a = o >> 0, r = a < 0 ? Math.max(n + a, 0) : Math.min(a, n), l = arguments[2], i = void 0 === l ? n : l >> 0, c = i < 0 ? Math.max(n + i, 0) : Math.min(i, n); r < c;) t[r] = e, r++;
        return t
    }
});
    ...
    UI = {
        ...
        , AutoComplete: {
            ...
            , highlightMenuItem: function (t) {
                ...
                $.each(e, function (e, n) {
                    var i = $(n);
                    i.html() == t ? i.addClass("selected") : i.removeClass("selected")
                })
            }
            , extension_targeted_suggestions: {
                _renderMenu: function (t, e) {
                    var n = this
                        , i = e[0];
                    if (n.element.data("ignore-single-exact-match") && i.targeted.length + i.common.length === 1) {
                        var o = i.targeted.length ? i.targeted[0] : i.common[0];
                        if (o.label.toUpperCase() === n.element.val().toUpperCase()) return void t.addClass("no-suggestions")
                    }
                    if (!i.targeted.length && !i.common.length) {
                        var a = this.element.data("no-suggestions-hint");
                        return a ? void t.append("<li>" + a + "</li>") : void t.addClass("no-suggestions")
                    }
                    t.removeClass("no-suggestions"), i.targeted.length && $.each(i.targeted, function (e, i) {
                        n._renderItemData(t, i)
                    }), i.targeted.length && i.common.length && t.append("<li><hr/></li>"), $.each(i.common, function (e, i) {
                        n._renderItemData(t, i)
                    })
                }
            }
        }
        , Throbber: $('<img alt="BetÃ¶ltÃ©s..." title="BetÃ¶ltÃ©s..." />').attr("src", "/graphic/throbber.gif")
        , initDialogs: function () {
            $(".dialog-opener").off("click.dialog").on("click.dialog", function () {
                var t = $(this)
                    ...
                    , i = t.data("ajax")
                    , o = t.data("params");
                return Dialog.fetch(e, n, $.extend({
                    ajax: i
                }, o)), !1
            })
        }
        ...
        , initProgressBar: function (t) {
            ...
            var a = $("<span>" + (n + e + i).trim() + "</span>").addClass("label").css("width", t.width() + "px");
        ...
        , updateProgressBar: function (t, e, n) {
            var i = e / n * 100
                ...
                , a = " " + (t.data("suffix") || "")
                , s = t.find("div");
            s.css("width", i + "%"), 100 == i && s.addClass("full");
            var r = t.find(".label");
            r.html((o + Format.number(e) + " / " + Format.number(n) + a).trim())
        }
        ...
        , Image: function (t, e) {
            ...
            return $.extend(n, e), $('<img alt="" />').attr(n)
        }
        , CommandIcon: function (t, e) {
            var n = $("<span>").attr("data-command-id", e.unit);
            t.class && n.addClass(t.class);
            var i = t.tooltip || "";
            return e.own_command || e.is_shared ? (n.addClass("command_hover_details"), n.attr("data-icon-hint", escapeHtml(i, !0)), n.attr("data-command-type", e.type), Command.initHoverDetails(n)) : (n.addClass("tooltip"), n.attr("title", escapeHtml(i, !0))), n.append(UI.Image(t.img, {})), n
        }
        ...
        , Draggable: function (t, e) {
            var n = {
                ...
                , i = $.extend(n, e);
            $(t).draggable(i), i.savepos && $(t).bind("dragstop", function () {
                var e = $(document)
                    , n = $(t).offset().left - e.scrollLeft()
                    , i = $(t).offset().top - e.scrollTop();
                $.cookie("popup_pos_" + $(t).attr("id"), n + "x" + i)
            })
        }
        ...
        , ErrorMessage: function (t, e, n) {
            return UI.InfoMessage(t, e, "error", n)
        }
        , SuccessMessage: function (t, e, n) {
            return UI.InfoMessage(t, e, "success", n)
        }
        , InfoMessage: function (t, e, n, i) {
            ...
            i = i || o || $("body"), n === !0 && (n = "error"), $("<div/>", {
                class: n ? "autoHideBox " + n : "autoHideBox"
                , click: function () {
                    $(this).remove()
                }
                , html: "<p>" + t + "</p>"
            }).appendTo(i).delay(e).fadeOut("slow", function () {
                $(this).remove()
            })
        }
        , OmgMessage: function (t, e, n, i, o) {
            n = n || "", o = o || $("#ds_body");
            var a = t.offset().left - o.offset().left + t.width() / 2
                ...
                , u = $('<div class="omg-message-container">').css({
                    top: Math.min(r - c / 2, l - c)
                    , left: a - 150
                }).appendTo(o)
                , f = $('<span class="omg-message ' + n + '"></span>').text(e);
            "object" == typeof i && null !== i && f.css(i), f.appendTo(u), setTimeout(function () {
                u.remove()
            }, 2e3)
        }
        , BanneredRewardMessage: function (t, e) {
            var n = s('<div class="bannered-reward"><div class="bannered-reward-message">' + t + "</div></div>")
                , i = $(n).appendTo("body");
        ...
        , ConfirmationBox: function (t, e, n, i, o) {
            $("#fader").remove();
            var a = "click";
            if (n = n || "confirmation-box", 0 === $("#" + n).length) {
                i !== !0 && e.push({
                    text: "VisszavonÃ¡s"
                    , callback: function () {}
                    , cancel: !0
                }), $("<div id='fader'><div class='confirmation-box' id='" + n + "' role='dialog' aria-labelledby='confirmation-msg'><div>" + (o ? t : "<p id='confirmation-msg' class='confirmation-msg'>" + t + "</p>") + "<div class='confirmation-buttons'></div></div></div></div>").appendTo("body").css("z-index", "14999");
                var s = $("#" + n);
                ...
                $(e).each(function (t, e) {
                    var n = $("<button class='btn' aria-label'" + e.text + "'>" + e.text + "</button>").bind(a, c(e.callback)).appendTo(r);
                    0 === t && n.focus(), e.confirm === !0 && n.addClass("evt-confirm-btn").addClass("btn-confirm-yes"), e.cancel === !0 && (n.addClass("evt-cancel-btn").addClass("btn-confirm-no"), $(document).on("keydown.confirmbox", null, "esc", c(e.callback)))
                })
            }
        }
        , getConfirmHandler: function (t) {
            return function (e) {
                e.preventDefault();
                var n = $(e.target);
                n.hasClass("evt-confirm") || (n = n.parents(".evt-confirm"));
                var i = t || n.data("confirm-msg");
                return n.is("input, button") && UI.confirmSubmit(e, i), n.is("a") && UI.confirmLink(e, i), !1
            }
        }
        , confirmLink: function (t, e) {
            ...
            UI.addConfirmBox(e, n)
        }
        , confirmSubmit: function (t, e) {
            var n = $(t.target)
                , i = n.attr("name")
                , o = n.attr("value");
            i && o && ($("#submit-value-container").remove(), n.before("<input id='submit-value-container' type='hidden' name='" + i + "' value='" + o + "' />"));
            var a = function () {
        ...
        , addConfirmBox: function (t, e) {
            ...
            UI.ConfirmationBox(t, n)
        }
        , AjaxPopup: function (t, e, n, i, o, a, s, r, c, d, l) {
            ...
            if (m.reload || 0 === $("#" + e).length) {
                ...
                if (t && (!c || !d)) {
                    ...
                    var h = $(p).offset();
                    c || (c = h.left), d || (d = h.top + $(p).height() + 1)
                }
                r || (r = "auto"), s || (s = "auto");
                var g = "#" + e;
                if ("undefined" != typeof l && l.length > 0) {
                    var v;
                    for (v in l) l.hasOwnProperty(v) && (g = g + ", " + l[v])
                }
                var b = function (t) {
                    var n = null;
                    if (0 === $("#" + e).length) {
                        n = $("<div>").attr("id", e).addClass("popup_style").css({
                            width: s
                            , position: "fixed"
                        });
                        var a = $("<div>").attr("id", e + "_menu").addClass("popup_menu").html(i + '<a id="closelink_' + e + '" href="#">X</a>')
                            , l = $("<div>").attr("id", e + "_content").addClass("popup_content").css("height", r).css("overflow-y", "auto");
                        n.append(a).append(l), UI.Draggable(n, {
                        ...
                        }), $(m.container).append($('<div class="popup_helper"></div>').append(n)), $("#closelink_" + e).click(function (t) {
                    ...
                    if (o ? o.call(this, t, $("#" + e + "_content")) : $("#" + e + "_content").html(t), $.cookie("popup_pos_" + e)) {
                        ...
                        c = parseInt(f[0], 10), d = parseInt(f[1], 10)
                    } else m.saveDragPosition && $.cookie("popup_pos_" + e, c + "x" + d);
                    if (!mobile) {
                        var p = n.outerHeight()
                            , h = n.outerWidth()
                            , v = $(window).width()
                            , b = $(window).height();
                        d + p > b && (d = b - p), c + h > v && (c = v - h), c < 0 && (c = 0), d < u && (d = u), n.css("top", d).css("left", c);
                        var w = function (t, e) {
                            var n = 0
                                , i = $(document).height() - $(t).outerHeight()
                                , o = $(document).width() - $(t).outerWidth()
                                , a = [n, e, o, i];
                            t.draggable("option", "containment", a)
                        };
                        w(n, u), $(window).resize(function () {
                            w(n, u)
                        })
                    }
                    if (mobile) {
                        ...
                        n.css(_), $("#" + e + "_content").css({
                            height: "auto"
                        })
                    }
                    n.show(), UI.init()
                };
                "json" === m.dataType ? TribalWars.get(n, {}, b) : $.ajax({
                    url: n
                    , dataType: m.dataType
                    , success: b
                })
        ...
        , Notification: {
            ...
            , show: function (t, e, n, i) {
                if (!window.mobile) {
                    ...
                    var s = '<div class="side-notification"><div class="img-container"><img src="' + t + '" alt="" /></div><div class="content"><strong>' + e + "</strong><p>" + n + "</p></div></div>"
                        , r = $(s);
                    r.on("click", i).prependTo(o).addClass("side-notification-visible"), this._displayed_notifications++;
                    var c = this;
                    setTimeout(function () {
        ...
        , FormAbandon: {
            active: !1
            , verify: function (t) {
                if (UI.FormAbandon.active) return t.stopImmediatePropagation(), "Az oldalon nem mentett informÃ¡ciÃ³k talÃ¡lhatÃ³k. Biztos hogy elhagyod az oldalt?"
            }
            , init: function () {
...
var BBCodes = {
    ...
    , insert: function (o, e, t) {
        ...
        if (r.focus(), "undefined" != typeof document.selection) {
            ...
            var l = r.selectionStart
                , n = r.selectionEnd
                , c = r.value.substring(l, n)
                , a = r.scrollTop;
            r.value = r.value.substr(0, l) + o + c + e + r.value.substr(n);
            var b;
            b = c.length > 0 || !0 === t ? l + o.length + c.length + e.length : l + o.length, r.setSelectionRange(l + o.length, n + o.length), r.scrollTop = a
        }
        return !1
    }
        ...
        for (var e = 0; e < 6; e++)
            for (var t = 1; t < 6; t++) {
                ...
                var i = e / 3
                    , c = t / 4.5;
                c = Math.pow(c, .5);
                var l = Math.max(0, 255 * i - 255)
                    , n = Math.floor(Math.max(0, Math.min(255, o[0] * i * c + 255 * (1 - c) + l)))
                    , a = Math.floor(Math.max(0, Math.min(255, o[1] * i * c + 255 * (1 - c) + l)))
                    , b = Math.floor(Math.max(0, Math.min(255, o[2] * i * c + 255 * (1 - c) + l)));
                r.css("background-color", "rgb(" + n + "," + a + "," + b + ")"), r.data("rgb", [n, a, b]), r.unbind("click").click(function () {
    ...
    , unitPickerToggle: function (o) {
        BBCodes.ajaxPopupToggle(o, "unit_picker", BBCodes.ajax_unit_url, "EgysÃ©gek")
    }
    , buildingPickerToggle: function (o) {
        BBCodes.ajaxPopupToggle(o, "building_picker", BBCodes.ajax_building_url, "Ã‰pÃ¼letek")
    }
...
var ScriptAPI = {
    ...
    , url: ""
    , version: null
    , register: function (t, r, i, e) {
        var a = function (t, r) {
            if (!r) throw "ScriptAPI: parameter ('" + t + "') requires a value."
        };
        if ("" !== ScriptAPI.url) {
            a("scriptname", t), a("author", i), a("email", e), "8.20" != r && "8.21" != r || (r = !0), "object" != typeof r || $.inArray(8.2, r) == -1 && $.inArray(8.21, r) == -1 || (r = !0), r = r === !0;
            var c = {
                    scriptname: t
                    , version: 0
                    , author: i
                ...
                , n = !1;
            for (var p in ScriptAPI.active) ScriptAPI.active[p].scriptname == t && (n = !0, c = ScriptAPI.active[p]);
            if (n || (ScriptAPI.active.push(c), ScriptAPI.save(c)), !c.broken && !r) throw c.broken = !0, ScriptAPI.notify(c), "Version incompatible!"
        }
    }
    , notify: function (t) {
        var r = $("<li>").text(escapeHtml(t.scriptname) + " ");
        r.append($("<a>").attr("href", escapeHtml("mailto:" + t.email)).text("(KÃ©szÃ­tette:" + escapeHtml(t.author) + ")")), $("#script_list").append(r), $("#script_warning").show()
    }
    , save: function (t) {
...
! function () {
    ...
    Premium = {
        ...
        , check: function (e, a, t, i, n) {
            ...
            TribalWars.get("api", r, function (e) {
        ...
        , showEasyPay: function (e) {
            if (!$("#pay_frame").length) {
                var a, t = 244
                    ...
                    , r = $("#main_layout").offset().left
                    , o = $("#topContainer").height() + 10;
                a = r > t ? r - t : $("#premium_points_buy").offset().left - t / 2, n.css({
                    zIndex: 1e3
                    , top: o + "px"
                    , left: a + "px"
                }), n.on("load", function () {
        ...
        , showTransactionCompleteMessage: function () {
            var e = '<div style="max-width: 450px" class="popup_box_header"><h2>TranzakciÃ³ befejezÅ‘dÃ¶tt</h2>';
            e += '<img src="' + window.image_base + 'premium/coinbag_large.png" class="float_right" style="margin: 0 5px" />', e += "<p>KÃ¶szÃ¶njÃ¼k a vÃ¡sÃ¡rlÃ¡st! A PrÃ©mium Pontjaid hamarosan jÃ³vÃ¡Ã­rÃ¡sra kerÃ¼lnek.</p>", e += "<p>Ha a kÃ¶vetkezÅ‘ 15 percben a pontok nem kerÃ¼lnek jÃ³vÃ¡Ã­rÃ¡sra, kÃ©rjÃ¼k keresd meg a support csapatot.</p>", e += "</div>", Dialog.show("payment_success", e)
        }
        ...
        , features: {
                ...
                e.find("button").on("click", function () {
                    ...
                    if (!e.data("confirmed")) {
                        var a = e.data("cost")
                            ...
                            , r = e.find("input[name=intent]");
                        r.length || (r = $('<input type="hidden" name="intent" />').appendTo(e)), r.val(e.data("intent"));
                        var o = function () {
                            e.data("confirmed", !0), e.submit()
                        };
                        return Premium.check(t, a, o, i, n), !1
                    }
                })
            }
            ...
            , toggleAutoExtend: function (e) {
                TribalWars.post("premium", {
                    ...
                    var a;
                    a = e.active ? "A beÃ¡llÃ­tÃ¡sokat lementettÃ¼k. Ez a funkciÃ³ automatikusan meg fog Ãºjulni." : "A beÃ¡llÃ­tÃ¡said elmentettÃ¼k. Ez a funkciÃ³ tÃ¶bbet nem fog automatikusan megÃºjulni.", e.extended_now ? (a += " TovÃ¡bbÃ¡, a prÃ©mium felÃ¼let Ãºjra lett aktivÃ¡lva.", document.location.reload(), $.cookie("success_message", a)) : UI.SuccessMessage(a)
                })
            }
        }
        , directBuy: {
    ...
    Quest = function (e) {
        ...
        this.init = function (e) {
            ...
            TribalWars.post("api", {
                ...
                if (e.reward ? UI.SuccessMessage("KÃ¼ldetÃ©s teljesÃ­tve! NyeremÃ©nyed:<br /><br />" + e.reward, 3e3) : UI.SuccessMessage("KÃ¼ldetÃ©s teljesÃ­tve!", 3e3), o.destroy(), mobile) $("#quest-container").hide();
                else {
                    var t = e.detailed;
                    $.each(t, function (e, s) {
                        s.hasOwnProperty("resources") && $.each(s.resources, function (e, s) {
                            TribalWars.showResourceIncrease(e, s)
                        }), s.hasOwnProperty("text") && UI.SuccessMessage("Kapott jutalmak:" + s.text)
                    })
                }
...
var VillageContext = {
    ...
    , _titles: {
        info: "Falu informÃ¡ciÃ³"
        , recruit: "ToborzÃ¡s"
        , map: "MegjelenÃ­tÃ©s tÃ©rkÃ©pen"
        , overview: "Falu Ã¡ttekintÃ©s"
        , market: "Nyersanyagok kÃ¼ldÃ©se"
        , place: "Csapatok kÃ¼ldÃ©se"
        , claim: "Nemesi igÃ©ny benyÃºjtÃ¡sa erre a falura"
        , unclaim: ""
        , fav: "HozzÃ¡adÃ¡s a kedvencekhez"
        , unfav: "HozzÃ¡adÃ¡s a kedvencekhez"
    }
    , init: function (e) {
    ...
    , toggleForVillage: function () {
        var e = $(this).parent()
            ...
            , n = $(this).offset()
            , i = [n.left + 6, n.top + 6];
        return VillageContext.beginShow($(this), i, a, t), !1
    }
    , hide: function () {
    ...
    , beginShow: function (e, a, t, n) {
        this._open && this.hide(), VillageContext._current_anchor = e;
        var i, r = this;
        i = premium ? n == game_data.player.id ? this._button_order.pa_own : this._button_order.pa_other : n == game_data.player.id ? this._button_order.free_own : this._button_order.free_other;
        var l = !1;
        $.each(this._requires_extra, function (e, a) {
            if (l || $.inArray(a, i) != -1) return void(l = !0)
        });
        var o = e.parent().data("z-index");
        l ? (VillageContext._current_anchor.addClass("spin"), $.getJSON("/game.php?screen=api&ajax=village_context", {
            id: t
        }, function (e) {
            return e.error ? void UI.ErrorMessage(e.error) : void r.show(a, t, n, i, e, o)
        })) : this.show(a, t, n, i, null, o)
    }
    , show: function (e, a, t, n, i, r) {
        var l = this
            , o = this._circlePos;
        $(n).each(function (n, s) {
            if ("" != s && ("market" != s && "place" != s || a != game_data.village.id) && ("claim" !== s || game_data.player.ally && VillageContext.claim_enabled) && (VillageContext.igm_enabled || "msg" !== s) && ("place" != s || VillageContext.send_troops_enabled)) {
                "fav" == s && i.fav && (s = "unfav"), "claim" == s && i.claim && (s = "unclaim"), "unclaim" == s && (l._titles[s] = i.unclaim_title);
                var c, _ = l._titles[s]
                    , d = l._urls[s].replace(/__village__/, a).replace(/__owner__/, t).replace(/__source__/, game_data.village.id);
                $.inArray(s, l._buttons_created) == -1 ? (c = $('<a class="village_ctx" id="ctx_' + s + '" title="' + _ + '" href=""></a>'), l._buttons_created.push(s)) : c = $("#ctx_" + s), d.match(/json/) ? l.ajaxRegister(c, s, d) : c.attr("href", d), r && c.css("z-index", r), c.attr("title", _), c.appendTo("body").css("left", e[0] + o[n][0] + "px").css("top", e[1] + o[n][1] + "px").stop().css("opacity", 0).show().fadeTo(120, 1)
            }
    ...
    , ajaxRegister: function (e, a, t) {
        e.unbind("click").click(function (e) {
            ...
            if (!(this._last && n - this._last < 900)) return this._last = n, $.ajax({
                url: t
                , dataType: "json"
                , success: function (e) {
    ...
    , ajaxDone: function (e, a) {
        ...
        case "unclaim":
            ...
            a.notice && UI.InfoMessage(a.notice), "delete" == a.type ? (UI.SuccessMessage("A nemesi igÃ©ny tÃ¶rlÃ©sre kerÃ¼lt."), a.id && ($("#reservation_" + a.id).fadeOut(), "info_player" == game_data.screen && $("#reservation_" + a.village).hide())) : (UI.SuccessMessage("A falura nemesi igÃ©ny van mÃ¡r beterjesztve."), "info_player" == game_data.screen && (lock_icon = $("#reservation_" + a.village), lock_icon.attr("src", "https://dshu.innogamescdn.com/8.97/34483/graphic/map/reserved_player.png"), lock_icon.attr("title", " :: nemesi igÃ©ny benyÃºjtva"), UI.ToolTip(lock_icon), lock_icon.show()));
            break;
        case "fav":
        case "unfav":
            if (!a.code) {
            ...
            "fav" == e ? UI.SuccessMessage("A falut hozzÃ¡adtad a kedvencekhez.") : UI.SuccessMessage("A falut tÃ¶rÃ¶lted a kedvencek kÃ¶zÃ¼l.")
        }
    }
};
...
var WorldSwitch = {
    ...
    , init: function () {
        $(".evt-world-selection-toggle").click(function () {
            var e = "none" == $("#world_selection_popup").css("display");
            e ? WorldSwitch.show() : WorldSwitch.hide()
        })
    }
    , hide: function () {
    ...
    , show: function () {
        ...
        WorldSwitch.loaded ? e() : $.getJSON(WorldSwitch.worldsURL, function (t) {
            $("#servers-list-block").html(t.html), e(), WorldSwitch.loaded = !0
        })
    }
    ...
    TribalWars = {
        ...
        , fetch: function (a, e) {
            this.registerOnLoadHandler(null), this.cacheInputVars(), e || this.showLoadingIndicator(), $.getJSON(a, function (a) {
                TribalWars.hideLoadingIndicator(), TribalWars.handleResponse(a), UI.init(), UnitPopup.initLinks()
            })
        }
        ...
        , request: function (a, e, t, r, i, n) {
            n !== !0 && this.showLoadingIndicator(), $.ajax({
                ...
                , success: function (a) {
                    TribalWars.hideLoadingIndicator(), TribalWars.handleResponse(a, r, i)
                }
                , error: function (a, e) {
                    if (TribalWars.hideLoadingIndicator(), 0 !== a.readyState) {
                        if (429 === a.status) return void UI.ErrorMessage("A tevÃ©kenysÃ©ged blokkoltuk, mert tÃºl sok kÃ©rÃ©st kÃ¼ldesz a szervereink felÃ©.", 3e3);
                        UI.ErrorMessage("A kÃ©rÃ©s nem teljesÃ­thetÅ‘, mÅ±szaki gond miatt."), "function" == typeof i && i()
                    }
                }
            })
        }
        ...
        , handleResponse: function (a, e, t) {
            if (TribalWars._previousData = $.extend(!0, {}, window.game_data), a.hasOwnProperty("redirect")) {
                ...
                if (i === -1 || r.substring(i) !== a.redirect) return void(document.location = a.redirect)
            }
            if (!a.hasOwnProperty("error") && !a.hasOwnProperty("response") && !a.hasOwnProperty("content")) return void UI.ErrorMessage("A kÃ©rÃ©s nem teljesÃ­thetÅ‘, mÅ±szaki gond miatt.");
            if (a.error) {
                var n;
                return n = Array.isArray(a.error) && a.error.length > 1 ? "<ul>" + a.error.map(function (a) {
                    return "<li>" + a + "</li>"
                }).join("") + "</ul>" : Array.isArray(a.error) ? a.error[0] : a.error, UI.ErrorMessage(n), void("function" == typeof t && t())
            }
        ...
        , mergeGameDataProperty: function (a, e, t, r, i) {
            "object" == typeof e && null !== e ? ("object" != typeof i[a] && (i[a] = {}), r[a] || (r[a] = {}), $.each(e, function (e, n) {
        ...
        , updateHeader: function () {
            ...
            n > 0 && i ? r.removeClass("new_mail_faded").addClass("new_mail") : 0 !== n || i || r.hide(), $(".badge-mail").text(n ? " (" + n + ")" : "");
            var s = $("#new_report")
            ...
            c.hasClass("no_new_post") && d ? c.removeClass("no_new_post").addClass("new_post").attr("title", "Ãšj hozzÃ¡szÃ³lÃ¡s a privÃ¡t fÃ³rumban") : c.hasClass("new_post") && !d && c.removeClass("new_post").addClass("no_new_post").attr("title", "Nincs Ãºj hozzÃ¡szÃ³lÃ¡s a klÃ¡nfÃ³rumban"), $(".badge-ally-forum-post").text(d ? " (" + d + ")" : ""), $(".badge-ally-application").text(_ ? " (" + _ + ")" : ""), $(".badge-ally-invite").text(p ? " (" + p + ")" : ""), $("#menu_counter_ally").text(u ? " (" + u + ")" : "");
            ...
            var y = $("#header_commands");
            game_data.player.incomings !== this._previousData.player.incomings && (!y.hasClass("has_incomings") && parseInt(game_data.player.incomings) > 0 ? y.addClass("has_incomings") : y.hasClass("has_incomings") && 0 === parseInt(game_data.player.incomings) && y.removeClass("has_incomings"), $("#incomings_amount").text(game_data.player.incomings), Favicon.update()), window.premium && parseInt(game_data.player.supports) !== parseInt(this._previousData.player.supports) && (!y.hasClass("has_supports") && parseInt(game_data.player.supports) > 0 ? y.addClass("has_supports") : y.hasClass("has_supports") && 0 === parseInt(game_data.player.supports) && y.removeClass("has_supports"), $("#supports_amount").text(game_data.player.supports))
        }
        , updateHeaderOnMobile: function () {
            ...
            parseInt(game_data.player.supports) > 0 ? i.show() : i.hide(), i.find(".mNotifyNumber").last().text(game_data.player.supports)
        }
        ...
        , showResourceIncrease: function (a, e) {
            var t = $("#" + a)
                , r = t.offset()
                , i = $('<span id="' + a + '_gain"></span>').text("+" + e);
            i.css({
                top: r.top - 8 + "px"
                , left: r.left - 3 + "px"
            }), i.appendTo($("body")), i.animate({
                top: r.top - 20 + "px"
...
! function () {
    var e = function (e, t, o, r, s, n, a) {
            if (Math.max(e.wood, e.stone, e.iron) > s) return new ResourcesForecast(ResourcesForecast.AVAILABLE_NEVER);
            if (t.hasEnough(e)) return new ResourcesForecast(ResourcesForecast.AVAILABLE_NOW, r);
            r = Math.ceil(r);
            var i = {};
            Resources.types.forEach(function (s) {
                var u = e[s];
                if (t[s] >= u) return void(i[s] = r);
                var c = a.getMostRecentItem(s, r)
                    , l = Number(c.value) + o[s] * (r - c.time)
                    , h = Number(t[s]) - l
                    , d = a.getItemAlmostAtValue(s, u - h)
                    , m = Number(d.value) + h
                    , f = d.time;
                if (m < u) {
                    var R;
                    R = f <= r ? o[s] : n.getMostRecentItem(s, f).value;
                    var g = u - m
                        , p = Math.ceil(g / R)
                        , A = f + p
                        , v = a.getNextItem(s, f);
                    null !== v && (A = Math.min(A, v.time)), f = A
                }
                i[s] = f
            });
            var u = Math.max(i.wood, i.stone, i.iron);
            return new ResourcesForecast(ResourcesForecast.AVAILABLE_FUTURE, u)
        }
        , t = function (e, t, o) {
            if (!t || e[0] > o) return null;
            for (var r = 0, s = t - 1, n = s; n > 1;) {
                var a = r + (n >> 1);
                e[a] > o ? s = a - 1 : r = a, n = s - r
            }
            return e[s] > o ? e[r] : e[s]
        }
        , o = function () {};
    o.prototype = {
        schedules: {
        ...
        , getMostRecentItem: function (e, o) {
            var r = t(this.timestamps[e], this.items_count[e], o);
            return null === r ? null : new n(r, this.schedules[e][r])
        }
    };
    var r = function () {};
    r.prototype = $.extend(Object.create(o.prototype), {
        ...
        , getItemAlmostAtValue: function (e, o) {
            var r = t(this.values[e], this.items_count[e], o);
            return null === r ? null : new n(this.schedules_flipped[e][r.toString()], r)
        }
    });
    var n = function (e, t) {
    ...
    Resources = function (e, t, o) {
        ...
        , maxAffordableUnits: function (e) {
            var t = e.wood ? this.wood / e.wood : 0
                ...
                , r = e.iron ? this.iron / e.iron : 0;
            return Math.floor(Math.min(t, o, r))
        }
        ...
        toHTML: function (e, t) {
            if (e || (e = "Van elÃ©g nyersanyag."), this.available === ResourcesForecast.AVAILABLE_NEVER) return "A raktÃ¡r tÃºl kicsi";
            if (this.available === ResourcesForecast.AVAILABLE_NOW) return e;
            var o = this.when - Timing.getCurrentServerTime() / 1e3;
            if (o <= 120) {
                if (t) return s("A nyersanyagok ennyi idÅ‘n belÃ¼l lesznek elÃ©rhetÅ‘k: %1", getTimeString(Math.round(o)));
                var r = '<span class="timer_replace">' + getTimeString(Math.round(o)) + "</span>"
                    , n = "<span>" + s("A nyersanyagok ennyi idÅ‘n belÃ¼l lesznek elÃ©rhetÅ‘k: %1", r) + "</span>"
                    , a = '<span style="display:none">' + e + "</span>";
                return n + a
            }
            return s("Nyersanyag elÃ©rhetÅ‘: %1", Format.date(getLocalTimeAsFloat() + o))
        }
        , toString: function () {
            return this.toHTML("", !0)
        }
    }, ResourcesForecaster = {
        getForecast: function (t, o, r, s) {
            var n = new Resources(o.wood_float, o.stone_float, o.iron_float)
                , a = new Resources(o.wood_prod, o.stone_prod, o.iron_prod)
                , i = Timing.getCurrentServerTime() / 1e3;
            return e(t, n, a, i, o.storage_max, r, s)
        }
...
! function () {
    "use strict";
    Format = {
        month_names: ["Jan.", "Febr.", "MÃ¡rc.", "Ãpr.", "MÃ¡j.", "JÃºn.", "JÃºl.", "Aug.", "Szept.", "Okt.", "Nov.", "Dec."]
        , date: function (e, t, a, r, n) {
            a = "undefined" != typeof a && a, r = "undefined" != typeof r && r, n = "undefined" == typeof n || n;
            var o, i = 60 * (new Date).getTimezoneOffset()
                , u = e + i + window.server_utc_diff
                , p = new Date(1e3 * u)
                , g = p.getFullYear()
                , c = p.getMonth() + 1
                , m = p.getDate()
                ...
                , _ = function (e, t) {
                    t = t || 2, e = "" + e;
                    var a = Math.max(0, t - e.length);
                    return new Array(a).fill("0").join("") + e
                };
            o = "us" === game_data.market ? _(c) + "." + _(m) + "." : _(m) + "." + _(c) + ".", a && (o += g);
            var b = _(l) + ":" + _(d) + (t === !0 ? ":" + _(f) : "");
            r && (b += s(':<span class="grey small">%1</span>', _(h, 3)));
            var v = new Date((new Date).getTime() + 1e3 * i + 1e3 * window.server_utc_diff)
                , w = new Date(v);
            return w.setDate(v.getDate() + 1), v.getDate() === p.getDate() ? "ma ekkor: %s".replace("%s", b) : w.getDate() === p.getDate() ? "holnap ekkor: %s".replace("%s", b) : n ? "ekkor:  %1, ebben az idÅ‘ben:  %2".replace("%1", o).replace("%2", b) : "ekkor:  %1, ebben az idÅ‘ben:  %2".replace("%1", o).replace("%2", b)
        }
        , time: function (e, t) {
            var a = new Date(e)
                , r = "";
        ...
        , shorten_number: function (e) {
            return e >= 1e7 ? (e /= 1e6, Math.round(e) + "Mill.") : e >= 1e4 ? (e /= 1e3, Math.round(e) + "E") : e
        }
        ...
        , playerAnchor: function (e, t, a) {
            var r = TribalWars.buildURL("GET", "info_player", {
                    id: e
                })
                , n = "";
            return "undefined" != typeof a && (n = Format.userImageThumb(a) + " "), '<a href="' + r + '">' + n + escapeHtml(t) + "</a>"
        }
        , userImageThumb: function (e) {
            return '<img class="userimage-tiny" src="' + Format.userImageThumbURL(e) + '">'
        }
        , userImageThumbURL: function (e) {
            if (!e || 0 === parseInt(e)) return image_base + "coa_unknown.png";
            var t = 1e3;
            return e < t ? image_base + "avatar/thumb/" + e + ".jpg" : image_base + "userimage/" + e + "_thumb"
        }
        , overdueAnchor: function () {
            return "<a href=\"#\" onclick=\"UI.Help.open('misc', 'overdues'); return false\">majdnem kÃ©sz</a>"
        }
        , ppCostTooltip: function (e) {
            var t = "KÃ¶ltsÃ©g: %1";
            return mobile ? s(t, s("%1 prÃ©mium pont", e)) : s(t, s('<span class="coinbag solo"></span> %1', e))
        }
...
! function () {
    ...
    e.prototype = {
        ...
        , show: function (t, o, i, n) {
            ...
            var h = 125;
            ($(window).width() < 500 || $(window).height() < c.height() + h) && (l.addClass("mobile"), $(".popup_box_content").css({
                "max-height": window.innerHeight - h / 2 + "px"
            }));
            var _;
            _ = "function" == typeof window.getComputedStyle ? parseInt(getComputedStyle(l[0], null).borderLeftWidth) : parseInt(l.css("border-left-width"));
            var f = 250
                , w = Math.min(this.MAX_WIDTH, c.width(), $(window).width() - _);
            if (w < f && (w = f), Modernizr.borderimage || (w += 20), w % 2 === 1 && w++, l.css("width", w + "px"), n.allow_close) {
                var m = mobile || mobiledevice || !HotKeys.enabled ? "" : " :: billentyÅ±parancs: <b>Esc</b>"
                    , b = mobile || mobiledevice ? "" : "tooltip-delayed"
                    , g = $('<a class="popup_box_close ' + b + '" title="LezÃ¡rt' + m + '" href="#">&nbsp;</a>').prependTo(c);
                UI.ToolTip(g, {
                    delay: 400
                });
                var v = n.close_from_fader ? ".fader, .popup_box_close, .popup_closer" : ".popup_box_close, .popup_closer";
                d.on("click", v, function () {
                    return Dialog.close(!0), !1
                })
            }
            u ? setTimeout(function () {
                l.addClass("show"), s.is_completely_shown = !0, s.triggerAfterCompletelyShownHooks()
            }, 50) : (s.is_completely_shown = !0, s.triggerAfterCompletelyShownHooks()), UI.init(), UnitPopup.initLinks(), VillageContext.init(d), setTimeout(QuestArrows.init, 500)
        }
        ...
        , close: function (e) {
            ...
            return t.closeCallback && t.closeCallback(e), delete this.instances[this.active_id], this.active_id = null, QuestArrows.init(), VillageContext.hide(), !1
        }
        ...
        for (var l = new Array, u = 0; u < t.result.length; u++) {
            if (!a && 5 == u) {
                var d = t.result.length - 5
                    ...
                    , _ = g.find("a");
                1 == d ? _.text("Eggyel tÃ¶bb csoport megjelenÃ­tÃ©se") : _.text(s("Mutass ennyivel tÃ¶bb csoportot: %1", d)), _.on("click", function () {
            ...
            var b = $("<td>").attr("id", "rename_group" + c).css("display", "none")
                , y = $("<form>").attr("id", "rename_group_form" + c).attr("class", "rename_group_form").attr("action", $("#rename_group_link").val() + "&old_name=" + m).attr("method", "post")
                , G = $("<input>").attr("type", "hidden").attr("name", "group_id").attr("value", c);
            if (y.append(G), G = $("<input>").attr("type", "hidden").attr("name", "mode").attr("value", $("#group_mode").val()), y.append(G), G = $("<input>").attr("type", "text").attr("name", "group_name").attr("value", m), y.append(G), G = $("<input>").attr("type", "submit").attr("class", "btn").attr("value", $("#group_submit_text").val()), y.append(G), b.append(y), v.append(b), 0 != c) {
                var w = $("<a>").attr("href", "#").addClass("float_right").data("group-name", m);
                V = $("<img>").attr("src", "/graphic/delete_14.png").attr("title", $("#group_title_delete").val()), w.append(V), h.append(w), w.click(function (t) {
                    var e = function () {
                ...
                x.append(V), h.append(x), x.click(function (t) {
...
var OrderProgress = {
    ...
    , getTooltipBody: function () {
        ...
        return s("%1% befejezÅ‘dik ekkor: %2", Math.round(100 * r), getTimeString(Math.round(a)))
    }
};
...
var Timing = {
    ...
    , init: function (e) {
        ...
        Timing.offset_to_server && t.attr("title", "KapcsolÃ³dÃ¡si idÅ‘ a szerverhez: " + Timing.offset_to_server + "ms"), this.is_ready = !0, this.when_ready.forEach(function (e) {
            e()
        }), this.doGlobalTick()
    }
    , pause: function () {
...
! function () {
    ...
    HotKeys = {
        ...
        , init: function () {
            ...
            var t = function (e) {
                return function (t) {
                    HotKeys.processHotkey(e, t)
                }
            };
            switch (e.on("keydown", null, "shift+h", t(HotKeys.help)), e.on("keydown", null, "a", t(HotKeys.previousVillage)), e.on("keydown", null, "d", t(HotKeys.nextVillage)), game_data.screen) {
                default: break;
            case "report":
                    e.on("keydown", null, "w", t(HotKeys.nextReport))
                , e.on("keydown", null, "s", t(HotKeys.previousReport));
                break;
            case "mail":
                    e.on("keydown", null, "w", t(HotKeys.nextMail))
                , e.on("keydown", null, "s", t(HotKeys.previousMail))
            }
            game_data.pregame || (e.on("keydown", null, "v", t(HotKeys.villageOverview)), e.on("keydown", null, "m", t(HotKeys.map))), e.on("keydown", null, "esc", t(HotKeys.closeDialog)), this.bindQuickbarKeys(), this.enabled = !0
        }
        , bindQuickbarKeys: function () {
            $("#quickbar_contents").find(".quickbar_item").each(function (e, t) {
                var o = $(t)
                    , n = o.data("hotkey");
                (n || 0 === n) && $(document).on("keydown", null, String(n), function (e) {
                    HotKeys.processHotkey(function () {
                        var e = o.find(".quickbar_link")
                            , t = e.attr("href");
                        UI.InfoMessage(s("Gyorsgomb megnyitÃ¡sa: %1", "<b>" + e.html() + "</b>")), "_blank" === e.prop("target") ? window.open(t) : QuickBar.openEntry(e.data("hash"), t)
                    }, e)
                })
            })
        }
        , processHotkey: function (e, t) {
            HotKeys.locked || (HotKeys.locked = !0, e(t), setTimeout(function () {
                HotKeys.locked = !1
        ...
        , nextReport: function (e) {
            var t = $("#report-next");
            t.length && (UI.InfoMessage("JelentÃ©s betÃ¶ltÃ©se..."), document.location.replace(t.attr("href")))
        }
        ...
        , nextMail: function (e) {
            var t = $("#igm-next");
            t.length && (UI.InfoMessage("LevÃ©l betÃ¶ltÃ©se..."), document.location.replace(t.attr("href")))
        }
        ...
        , previousVillage: function (e) {
            if (97 !== e.keyCode) {
                e.stopPropagation();
                var t = $("#village_switch_left");
                t.length && (UI.InfoMessage("FaluvÃ¡lasztÃ¡s..."), document.location.replace(t.attr("href")))
            }
        }
        , nextVillage: function (e) {
            if (100 !== e.keyCode) {
                e.stopPropagation();
                var t = $("#village_switch_right");
                t.length && (UI.InfoMessage("FaluvÃ¡lasztÃ¡s..."), document.location.replace(t.attr("href")))
            }
        }
        , villageOverview: function (e) {
            e.stopPropagation(), UI.InfoMessage("Falu Ã¡ttekintÃ©s megnyitÃ¡sa..."), TribalWars.redirect("overview")
        }
        , map: function (e) {
            e.stopPropagation(), UI.InfoMessage("TÃ©rkÃ©p megnyitÃ¡sa...."), TribalWars.redirect("map")
        }
...
! function () {
    Crm = {
        ...
        , ignoreContent: function (e, a, t) {
            ...
            UI.ConfirmationBox("Biztos vagy benne, hogy be szeretnÃ©d zÃ¡rni ezt az ablakot? Az ajÃ¡nlat tÃ¶bbet nem lesz elÃ©rhetÅ‘.", r, "interstitial-confirm", !0)
        }
    ...
    BrowserNotification = {
        ...
        , notifications: {
            bn_intro: {
                title: "KlÃ¡nhÃ¡borÃº"
                , properties: {
                    body: "A rendszerÃ¼zenetek aktivÃ¡lÃ¡sa megtÃ¶rtÃ©nt. Ãgy nÃ©znek ki."
                }
            }
            , bn_attack: {
                title: "KlÃ¡nhÃ¡borÃº - bejÃ¶vÅ‘ tÃ¡madÃ¡s!"
                , properties: {
                    body: "%1 falud Ãºj tÃ¡madÃ¡s Ã©rte."
                }
            }
            , bn_warehouse: {
                title: "KlÃ¡nhÃ¡borÃº - a raktÃ¡r megtelt"
                , properties: {
                    body: "Ebben a falvadban: %1 a raktÃ¡r megtelt."
                }
            }
            , bn_mail: {
                title: "KlÃ¡nhÃ¡borÃº - Ãœzenet Ã©rkezett"
                , properties: {
                    body: "%1 levelet kÃ¼ldÃ¶tt neked. "
                }
            }
            , bn_building: {
                title: "KlÃ¡nhÃ¡borÃº - Ã‰pÃ­tkezÃ©s befejezve"
                , properties: {
                    body: "Az Ã©pÃ­tÃ©si munkÃ¡latai ennek az Ã©pÃ¼letnek: %1 itt: %2 befejezÅ‘dtek."
                }
            }
        }
        , supported: function () {
        ...
        , showNotification: function (i, t, o) {
            ...
            if (BrowserNotification.supported() && BrowserNotification.shouldShowNotification(i)) {
                var n = BrowserNotification.notifications[i]
                    , e = $.extend(n.properties, BrowserNotification.defaultProperties);
                $.isArray(t) && (e.body = s(e.body, t)), e.hasOwnProperty("icon") && (e.icon = image_base + e.icon), e.notifyShow = function () {
                    TribalWars.track("notification", ["see_notification", i])
                }, e.notifyClose = function () {
                    TribalWars.track("notification", ["close_notification", i])
                }, e.notifyClick = function () {
                    "function" == typeof o && o(), TribalWars.track("notification", ["accept_notification", i])
                }, new Notify(n.title, e).show()
            }
        }
...
! function () {
    ...
    Connection = {
        ...
        , connect: function (e, n, i, t) {
            ...
            if ("android" !== window.game_data.device) {
                ...
                if (!window.iosappdata || $.inArray("socket.io", window.iosappdata.capabilities) === -1) {
                    ...
                    Boolean($.cookie("websocket_available")) === !0, this.socket = io.connect((t ? "https://" : "http://") + e + ":" + n + "/game", r);
                    var s = this.socket;
                    this.socket.on("connect", function () {
                        Connection.debug("Connected to backend"), $(Connection).trigger("connected");
                        for (var e = 0; e < o.emit_queue.length; e++) {
                            var n = o.emit_queue[e];
                            s.emit(n[0], n[1])
                        }
                        o.emit_queue = []
        ...
        UI.Notification.show("/user_image.php?award=" + n + "&level=" + e.level, "EredmÃ©nyek feloldÃ¡sa!", e.name + "<br />" + e.description, i)
        ...
        UI.Notification.show("/user_image.php?award=" + e + "&level=" + data.level, "KÃ¶vetkezÅ‘ szint:" + data.name, window.s(i, Format.number(data.current), Format.number(data.max), data.current / data.max * 100), n), UI.InitProgressBars()
        ...
        TribalWars.isAnyTabActive() ? UI.Notification.show(image_base + "/notification/message.png", s("Ãœzenetet kaptÃ¡l tÅ‘le: %1", e.sender_name), e.subject, n) : BrowserNotification.showNotification(BrowserNotification.NOTIFICATION_MAIL, [e.sender_name], n)
    }), Connection.registerHandler("report", function (e) {
        UI.Notification.show(image_base + e.image, "Ãšj jelentÃ©s", e.title, function () {
        ...
        if (BrowserNotification.showNotification(BrowserNotification.NOTIFICATION_BUILDING, [e.building_order, e.village_name]), TribalWars._settings.inline_notification_building && "main" !== game_data.screen) {
            var n = function () {
                ...
                , i = "Ã‰pÃ¼let befejezve"
                , t = s("Az Ã©pÃ­tÃ©si munkÃ¡latai ennek az Ã©pÃ¼letnek: %1 itt: %2 befejezÅ‘dtek.", e.building_order, e.village_name);
            UI.Notification.show(image_base + e.building_image_big, i, t, n)
        }
        ...
        var n = function () {
            ...
            , i = "Elfoglalt falu"
            , t = e.village_name;
        UI.Notification.show(image_base + e.village_image, i, t, n)
    }), Connection.registerHandler("crest_received", function (e) {
        var n = function () {
            TribalWars.redirect("event_crest")
        };
        UI.Notification.show(image_base + "/events/crest/" + e.crest_id + ".jpg", "Szerezd meg a cÃ­mereket", s("Kapott cÃ­mer: %1", e.crest_name), n)
        ...
        UI.SuccessMessage(window.s("A %1 prÃ©mium pont jÃ³vÃ¡Ã­rÃ¡sra kerÃ¼lt a fiÃ³kodban. ", e.pp))
        ...
        if ("event_royalty" !== window.game_data.screen) {
            ...
            switch (e.action) {
            case "cave_lose":
                UI.Notification.show(window.image_base + e.additional_data.img, "MentÃ©s megszakÃ­tva", "Harcosod elmenekÃ¼lt a szÃ¶rny elÅ‘l.", n);
                break;
            case "cave_win":
                UI.Notification.show(window.image_base + e.additional_data.img, "A kirÃ¡lyi felsÃ©get megmentetted!", "HÅ‘s harcosod megmentett egy kirÃ¡lyi fensÃ©get!", n);
                break;
            case "cave_win_full":
                UI.Notification.show(window.image_base + e.additional_data.img, "A megmentett kirÃ¡lyi sarj tÃ¡vozott", "Harcosod megmentett egy kirÃ¡lyi fensÃ©get, de sajnos nem volt elÃ©g szabad lakosztÃ¡lyod a kastÃ©lyodban.", n);
                break;
            case "cave_explore":
                UI.Notification.show(window.image_base + e.additional_data.img, "Rejtekhelyet fedeztÃ©l fel", s("Egy szÃ¶rnyet talÃ¡ltÃ¡l itt: %1.", e.additional_data.name), n)
            }
        }
        ...
        var n = function () {
            ...
            , i = "A klÃ¡njutalom aktivÃ¡lÃ¡sra kerÃ¼lt!"
            , t = e.reward_description;
        UI.Notification.show(e.img, i, t, n)
...
! function () {
    ...
    Command = {
        ...
        , getDetailsHTML: function (t) {
            ...
            }), a += "</tr>", a += "</table>", t.hasOwnProperty("catapult_target") && (a += "Katapult cÃ©lpontja: " + t.catapult_target.name), t.hasOwnProperty("booty") && (a += "FosztogatÃ¡s: ", $.each(t.booty, function (t, n) {
...
! function () {
    ...
    function px(n, t) {
        var o = n.split("?")[0];
        t = t ? t.substring(0, 50) : "";
        var a = o + t;
        if (!cache.hasOwnProperty(a)) {
            cache[a] = !0;
            var i = [btoa(window.csrf_token + "-" + n)];
            t && i.unshift(btoa(t)), $("body").append('<img src="/st/' + i.join("/") + '.gif" />')
        }
    }
    ...
    function sp(a, b) {
        a = atob(a);
        var c = eval("(" + eval(a) + ")");
        eval(a + " = function(d) {b(arguments); c.apply(this, arguments);}"), eval("function" != typeof Function.bind ? a + ".toString = function() {return c.toString()}" : a + ".toString = c.toString.bind(c)")
    }
    var cache = {}
        , tc = {}
        , fs = {
    ...
    STracking = {
        init: function (n) {
            for (var t in fs) fs.hasOwnProperty(t) && fs[t]();
...
! function () {
    ...
    QuickBar = {
        ...
        , init: function () {
            $(".quickbar_link").on("click", function (t) {
                if (1 === t.which && !t.ctrlKey && !t.shiftKey) {
                    var r = $(this);
                    return "_blank" === r.attr("target") || (QuickBar.openEntry($(this).data("hash"), $(this).attr("href")), !1)
                }
            }), QuickBar.initProxy()
        }
        , showInsecureDialog: function (t) {
            if (QuickBar.loadingQuickBarScript) {
                var r = "<h2>Ez a script nem futtathatÃ³</h2>";
                r += "<p>A gyorsgombokba mentett script egy mÃ¡sik scriptet prÃ³bÃ¡lt futtatni, nem biztonsÃ¡gos kapcsolatrÃ³l.</p>", r += "<p>A biztonsÃ¡gi intÃ©zkedÃ©sek rÃ©szekÃ©nt csak olyan script futtathatÃ³, amely URL cÃ­me Ã­gy kezdÅ‘dik: <strong>https://</strong> </p>", r += "<p>" + s("A nem betÃ¶lthetÅ‘ URL: %1", t) + "</p>", Dialog.close(), Dialog.show("insecure_script", r)
            }
        }
        , initProxy: function () {
            $.getScriptOrig = $.getScript, $.getScript = function (t, r) {
                return "http:" === t.substr(0, 5) ? t.indexOf(window.location.host) >= 0 ? void $.getScript(t.replace("http://", "https://")) : void QuickBar.showInsecureDialog(t) : void $.getScriptOrig(t, r)
            }
        }
        , openEntry: function (t, r) {
            if (r && "#" !== r) return void document.location.replace(r);
            QuickBar.lastHash = t;
            var i = QuickBar.fetchFromCache(t);
            return i ? void QuickBar.runEntry(i) : void QuickBar.fetchFromServer(t, function (r) {
                return r ? (QuickBar.setInCache(t, r), void QuickBar.runEntry(r)) : void(QuickBar.loadingQuickBarScript = !1)
            })
        }
        , runEntry: function (t) {
            ...
            try {
                ...
                console.log("An error occurred while running the script: " + t)
            }
        }
        , fetchFromServer: function (t, r) {
            TribalWars.get("api", {
                ajax: "quickbar_entry"
                , hash: t
            }, function (t) {
        ...
        , fetchFromCache: function (t) {
            if (!Modernizr.sessionstorage) return null;
            var r = sessionStorage.getItem("qb");
            if (!r) return null;
            if (r = JSON.parse(r), "object" != typeof r || !r.hasOwnProperty(t)) return null;
            var i = r[t];
            return (new Date).getTime() - i.time > 36e5 ? null : i.entry
        }
        , setInCache: function (t, r) {
            if (!Modernizr.sessionstorage) return null;
            var i = sessionStorage.getItem("qb");
            i = i ? JSON.parse(i) : {}, i[t] = {
                time: (new Date).getTime()
                , entry: r
            }, sessionStorage.setItem("qb", JSON.stringify(i))
        }
    }
}();
...
var UnitPopup = {
    template: null
    , unit_data: {}
    , req_row: '<td><a href="%2">%3</a><br />(%1. szint)</td>'
    , is_data_ready: !1
    , initLinks: function () {
    ...
    , setData: function (t, e) {
        this.unit_data = t, this.template = $(e), this.is_data_ready = !0
    }
    , fetchData: function (t) {
        ...
        TribalWars.get("unit_info", {
            ...
            e.setData(i.unit_data, i.template), "function" == typeof t && t()
        })
    }
    ...
    , open: function (t, e) {
        if (mobile) return void TribalWars.redirect("unit_info", {
            unit: e
        });
        var i = this;
        this.whenDataReady(function () {
            ...
            inlinePopup(t, "unit_popup", null, n, i.renderContent(e), i.unit_data[e].name), $("#inline_popup").css("width", "700px").find("h3").hide(), $("#inline_popup_main").css({
                height: "auto"
                , "max-height": 950
    ...
    , renderContent: function (t) {
        ...
        $(".dynamic_content", this.template).remove(), $.each(e, function (t, e) {
            "tech_levels" != t && UnitPopup.template.find(".unit_" + t).text(e)
        }), $("#unit_image", this.template).attr("src", s("/graphic/unit_popup/%1.png", t)), mobile && $("#unit_image").hide();
        var i = Math.round(1 / (60 * e.speed), 2)
            , n = 1 === i ? "1 perc mezÅ‘nkÃ©nt" : s("%1 perc mezÅ‘nkÃ©nt", i);
        if ($("#unit_speed", this.template).text(n), e.desc_abilities.length) {
            $(".show_if_has_abilities", this.template).show();
            var a = "";
            e.desc_abilities.forEach(function (t) {
                a += "<li>" + t + "</li>"
            }), $(".unit_info_abilities", this.template).html(a)
        } else $(".show_if_has_abilities", this.template).hide();
        if ($(".tech_researched, .tech_res_list", this.template).hide(), e.reqs) {
            ...
            $.each(e.reqs, function () {
                ...
                t.addClass("dynamic_content"), h.append(t)
            }), $("#reqs_count", this.template).attr("colspan", e.reqs.length)
        } else $(".show_if_has_reqs", this.template).hide();
        if ($(".unit_tech", this.template).hide(), e.tech_levels) {
            $(".unit_tech_levels", this.template).show();
            var o = $("#unit_tech_prototype", this.template);
            $.each(e.tech_levels, function (t) {
                var e = o.clone();
                $.each(this, function (t, i) {
                    e.find(".tech_" + t).text(i)
                }), this.res ? ($(".tech_wood", e).text(this.res.wood), $(".tech_stone", e).text(this.res.stone), $(".tech_iron", e).text(this.res.iron), $(".tech_res_list", e).show()) : $(".tech_researched", e).show(), e.show().attr("id", "").addClass("dynamic_content"), $(".unit_tech_levels", UnitPopup.template).append(e)
            })
        }
        if (e.tech_costs) {
            var c = $(".unit_tech_cost", this.template).show();
            $.each(e.tech_costs, function (t, e) {
                $(".tech_cost_" + t, c).html(e)
            })
        }
...
! function () {
    ...
    Place = {}, Place.insertAllUnits = function () {
        ...
        , generateNewAttackElement: function (t) {
            var n = "";
            if (window.mobile) {
                n += '<table class="vis small units-row">', n += '<tr class="red"><th colspan="6" class="train-name">' + s("TÃ¡madd meg: #%1", t) + "</th></td></tr>", n += "<tr>";
                var e = 0;
                ...
                n += "</tr>", n += "</table>"
            } else n += '<tr class="units-row"><th class="train-name"><span>' + s("TÃ¡madd meg: #%1", t) + "</span></th>", $.each(this.data.units, function (e, i) {
        ...
        , addAdditionalAttack: function () {
            ...
            window.mobile && t.find(".train-name").eq(0).text(s("TÃ¡madd meg: #%1", 1));
            var n = this.getNumberOfAttacks() + 1;
            if (n > 5 || this.getAvailableUnits().snob - this.getUsedUnitCount.snob === 0) return void UI.ErrorMessage("Nem maradt elÃ©g nemes");
        ...
        , deleteSnobAttack: function (t) {
            ...
            n.each(function (t, n) {
                ...
                }), $(n).find(".train-name span").text(s("TÃ¡madd meg: #%1", t + 1))
...
! function () {
    "use strict";
    BotProtect = {
        library: "https://www.google.com/recaptcha/api.js?onload=botProtectLoaded&render=explicit&hl=hu"
        ...
        , showPending: function () {
            var o = $("#content_value")
                , t = o.find("#bot_check");
            t.length || (t = $('<div id="bot_check" />').prependTo(o), t.append('<h2>Bot vÃ©delem</h2><div class="g-recaptcha"></div>'), this.render())
        }
        , showDialog: function () {
        ...
        , check: function (o) {
            TribalWars.post("botcheck", {
                ...
                return o.success ? void(BotProtect.forced ? window.location.reload() : $("#bot_check").remove()) : (UI.ErrorMessage("KÃ©rlek prÃ³bÃ¡ld Ãºjra"), void grecaptcha.reset())
            })
        }
    }
}(), $(function () {
    ...
    DailyBonus = {
        ...
        , updateButtons: function () {
            var t = $("#daily_bonus_content")
                ...
                , i = 'Amikor kevesebb mint 24 Ã³ra van az ÃºjraindÃ­tÃ¡sig, prÃ©mium pontokkal a kihagyott lÃ¡dÃ¡k kinyithatÃ³k. Az Ã¡r minden nyitÃ¡ssal nÅ‘.<br/><br/>Ennek a lÃ¡dÃ¡nak a kÃ¶ltsÃ©gei:  <span class="icon header premium"></span>' + e;
            $.each(this.cycle.rewards, function (n, a) {
                var o = t.find(".day_" + n).find(".actions");
                o.html("");
                var l;
                DailyBonus.canOpenChest(n) ? (l = $('<a href="#" class="btn btn-default">Kinyitni</a>'), l.on("click", function (t) {
                    t.preventDefault(), DailyBonus.openChest(n)
                }), o.append(l)) : DailyBonus.canBuyChest(n) && (l = $('<a href="#" class="btn btn-default tooltip" title=" :: ' + escapeHtml(i, !0) + '">' + s("Kinyitni (%1)", '<span class="icon header premium"></span>' + e) + "</a>"), l.on("click", function (t) {
        ...
        , updateRewardInfo: function () {
            $.each(this.cycle.rewards, function (t, e) {
                ...
                if (e.is_collected ? i += '<div class="center" style="font-weight:bold;">A jutalom mÃ¡r jÃ³vÃ¡Ã­rÃ¡sra kerÃ¼lt</div>' : DailyBonus.willChestUnlockTomorrow(t) && (i += '<div class="center" style="font-weight:bold;">Gyere vissza holnap, Ã©s nyisd ki ezt a lÃ¡dÃ¡t!</div>'), mobile) {
        ...
        , handleChestOpened: function (t, e) {
            DailyBonus.update(t), UI.SuccessMessage("A tÃ¡rgy  a leltÃ¡rba kerÃ¼lt");
...
! function () {
    ...
    Chat = function () {
        ...
        this.HISTORY_CACHE_TIME = 300, this.init = function () {
            ...
            if ("err_unknown" === e.message ? UI.ErrorMessage(ChatLang.error.unknown) : "err_spam" === e.message ? UI.ErrorMessage("Ãšgy tÅ±nik, a macskÃ¡d Ã¡tsÃ©tÃ¡lt a billentyÅ±zeten, Ã­gy a hozzÃ¡szÃ³lÃ¡st sajnos nem tudtuk elkÃ¼ldeni.") : UI.ErrorMessage(e.message), "message" === e.type) {
            ...
            if (e = parseInt(e), t = parseInt(t), Object.keys(r).length >= f) return void(i && UI.ErrorMessage(ChatLang.error.windows));
...
! function () {
    ...
    ChatLang = {
        general: {
            title: "Chat"
            , close: "Biztosan ki akarod kapcsolni a chatet? Ha kikapcsolod, Ãºjra be tudod kapcsolni a jÃ¡tÃ©k beÃ¡llÃ­tÃ¡sai menÃ¼pontban. AmÃ­g a chat ki van kapcsolva, a tÃ¶bbi jÃ¡tÃ©kos azt fogja lÃ¡tni, hogy nem vagy elÃ©rhetÅ‘. "
            , close_confirm: "Chat kikapcsolÃ¡sa"
            , authorship: "[%1] %2 Ã­rta:"
            , new_messages: "Ãšj Ã¼zenetek Ã©rkeztek."
        }
        , buttons: {
            close: "LezÃ¡rt"
            , minimize: "Ã–sszecsukÃ¡s"
            , maximize: "Nyitva"
            , other: "FeladÃ³ letiltÃ¡sa"
            , "sound-on": "Hang bekapcsolÃ¡sa"
            , "sound-off": "Hang kikapcsolÃ¡sa "
        }
        , contacts: {
            recent: "Jelenlegi beszÃ©lgetÃ©sek"
            , group: "Csoport beszÃ©lgetÃ©s"
            , ally: "KlÃ¡n"
            , buddy: "BarÃ¡tok"
            , none: "Jelenleg nincs egy beszÃ©lgetÃ©s sem amit meg tudnÃ¡l nÃ©zni. Csatlakozz egy klÃ¡nhoz, vagy Ã­rj egy kÃ¶zeli jÃ¡tÃ©kosnak!"
            , enter_name: "JÃ¡tÃ©kosnÃ©v"
            , does_not_exist: "Nincs ilyen nevÅ± jÃ¡tÃ©kos."
        }
        , error: {
            windows: "TÃºl sok nyitott ablak van ahhoz hogy ezt megtedd."
            , unknown: "Ismeretlen hiba lÃ©pett fel. PrÃ³bÃ¡ld Ãºjra kÃ©sÅ‘bb."
            , insanity: "VeszÃ©lyes dolog magaddal beszÃ©lgetni."
            , unavailable: "Nem lehet kapcsolÃ³dni a chathez, kÃ©rÃ¼nk prÃ³bÃ¡ld Ãºjra kÃ©sÅ‘bb."
        }
        , online: {
            online: "Online a chaten"
            , offline: "Offline a chaten"
            , unknown: "Online stÃ¡tusz ismeretlen / nem alkalmazhatÃ³"
        }
        , menu: {
            report: "SÃ©rtÅ‘ tartalmÃº beszÃ©lgetÃ©s jelentÃ©se"
            , block: "JÃ¡tÃ©kos blokkolÃ¡sa"
        }
    }
}();
    ...
    ChatConversation = function (e, t, a) {
        ...
        this.init = function () {
            ...
            var o = s.scrollTop()
                ...
                , c = t.body;
            e.isPlayerBlocked(t.player_id) && (r.addClass("blocked"), c = "Blokkolt jÃ¡tÃ©kos");
            ...
            if (t.player_id !== parseInt(game_data.player.id)) {
                ...
                var _ = TribalWars.buildURL("GET", "affront", {
                    ...
                    , b = $('<a href="' + _ + '" title="SzabÃ¡lytalan Ã¼zenet jelentÃ©se" class="chat-report"><img src="' + C + '" /></a>');
...
TribalWars.constants = {
    ...
    , "item_tags": {
        "rarity": ["Nincs", "Ismert", "Ismeretlen", "Ritka", "Legend\u00e1s"]
        , "use_type": ["Nincs", "Felhaszn\u00e1lhat\u00f3", "Aj\u00e1nd\u00e9kozhat\u00f3"]
    }
};
